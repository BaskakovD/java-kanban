...
//
//        inMemoryTaskManager.createSubTask(new SubTask("Фундамент", "Заливка фундамента весной 2024", Status.IN_PROGRESS, 4));
//        inMemoryTaskManager.createSubTask(new SubTask("Коробка дома", "Закупка кирпича и строительство коробки дома летом 2023", Status.NEW, 4));
//        inMemoryTaskManager.createSubTask( new SubTask("Разводка", "Создание внутренней проводки весной 2025", Status.NEW, 5));
//        inMemoryTaskManager.createSubTask(new SubTask("Электричество", "Создание внешней проводки весной 2026", Status.NEW, 5));
//
