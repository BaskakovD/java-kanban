...
public class Main {
    public static void main(String[] args) {
        ...
        String history1Size = String.format("Размер истории равен: %s", inMemoryTaskManager.getHistoryManager().getHistory().size());
        ...
        String history2Size = String.format("Размер истории равен: %s", inMemoryTaskManager.getHistoryManager().getHistory().size());
        ...
        String history3Size = String.format("Размер истории равен: %s", inMemoryTaskManager.getHistoryManager().getHistory().size());
        ...
        String history6Size = String.format("Размер истории равен: %s", inMemoryTaskManager.getHistoryManager().getHistory().size());
        ...
        String history7Size = String.format("Размер истории равен: %s", inMemoryTaskManager.getHistoryManager().getHistory().size());
        ...
        String history1SizeRepeat = String.format("Размер истории НЕ ИЗМЕНИЛСЯ и равен: %s", inMemoryTaskManager.getHistoryManager().getHistory().size());
        String printHistory = String.format("История задач: %s", inMemoryTaskManager.getHistoryManager().getHistory());
